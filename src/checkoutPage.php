...
<body> 
  ...
  <div class="row">       
     <div class="col-75">
       <div class="container"> 
         <form action="./php/paymentSuccess.php" method="POST"> <!-- Shipping & Payment Form -->
            <div class="row">
               <div class="col-50">
        ...
        <input type="submit" value="Continue to checkout" class="btn" >                      <!-- Checkout button that will store the form data and send user to paymentSuccesful page -->
      </form>
    </div>
  </div>
